...
const HFCAIdentityService = require('./HFCAIdentityService');
...
var FabricCAServices = class extends BaseClient {
	...
	/**
	 * Creates a new {@link HFCAIdentityService} object
     *
     * @returns {HFCAIdentityService} object
     */
  	newHFCAIdentityService() {
		return this._fabricCAClient.newHFCAIdentityService();
	}
...
var FabricCAClient = class {
     ...
     */
	newHFCAIdentityService() {
		return new HFCAIdentityService(this);
	}
