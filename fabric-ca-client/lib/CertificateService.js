...
class CertificateService {
	 ...
	 * @property {string} revoked_start Get revoked certificates starting at the specified time, either as timestamp (RFC3339 format) or duration (-30d)
	 * @property {string} revoked_end Get revoked certificates before the specified time, either as timestamp (RFC3339 format) or duration (-15d)
	 * @property {string} expired_start Get expired certificates starting at the specified time, either as timestamp (RFC3339 format) or duration (-30d)
	 * @property {string} expired_end Get expired certificates before the specified time, either as timestamp (RFC3339 format) or duration (-15d)
	 ...
	 * @property {string} ca The name of the CA to direct this request to within the server, or the default CA if not specified
	 */
