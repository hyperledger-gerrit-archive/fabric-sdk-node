...
// Use nyc to generate coverage report
...
gulp.task('run-test:cucumber', shell.task(
	'export HFC_LOGGING=\'' + cucumber_log + '\'; nyc npm run test:cucumber'
));
// Definition of Typescript Cucumber (scenario) test suite
gulp.task('run-test:ts-cucumber', shell.task(
	'export HFC_LOGGING=\'' + cucumber_log + '\'; nyc npm run test:ts-cucumber'
));
