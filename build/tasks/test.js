...
gulp.task('run-test', ['clean-up', 'lint', 'pre-test', 'compile', 'ca', 'run-test-mocha', 'run-tape-unit', 'run-tape-e2e', 'run-test-cucumber']);

// Run all non-integration tests
gulp.task('run-test-headless', ['clean-up', 'lint', 'pre-test', 'ca', 'run-test-mocha', 'run-tape-unit']);
