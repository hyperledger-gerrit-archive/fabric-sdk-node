...
const darwinTarFile = 'hyperledger-fabric-darwin-amd64-1.4.0.tar.gz';
const amd64TarFile = 'hyperledger-fabric-linux-amd64-1.4.0.tar.gz';
const s390TarFile = 'hyperledger-fabric-linux-s390x-1.0.4.tar.gz';
const mac = 'darwin-amd64-1.4.0/' + darwinTarFile;
const amd64 = 'linux-amd64-1.4.0/' + amd64TarFile;
const s390 = 'linux-s390x-1.0.4/' + s390TarFile;
