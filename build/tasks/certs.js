...
const tarFile = 'hyperledger-fabric-linux-amd64-1.4.0.tar.gz';
const amd64 = 'linux-amd64-1.4.0/';
const s390 = 'linux-s390x-1.0.4/';
const binariesRoot = 'https://nexus.hyperledger.org/content/repositories/releases/org/hyperledger/fabric/hyperledger-fabric/';
const amd64Binaries = binariesRoot + amd64 + tarFile;
const s390Binaries = binariesRoot + s390 + tarFile;
...
gulp.task('get-crypto-binaries-amd64', shell.task(
	...
	'tar xvzf ' + binariesPath + '/' + tarFile + ' -C ' + binariesPath + ';' +
