...
describe('Client', () => {
	...
	describe('#newPeer', () => {
		...
		it('should return an instance', () => {
			const inst = client.newPeer('name');
			inst.type.should.equal('Peer');
			inst.name.should.equal('name');
		});
		it('should return an instance with mspid', () => {
			const inst = client.newPeer('name', 'mspid');
			inst.type.should.equal('Peer');
			inst.name.should.equal('name');
	...
	describe('#getPeer', () => {
		...
		it('should return an instance', () => {
			const inst = client.getPeer('name');
			inst.type.should.equal('Peer');
			inst.name.should.equal('name');
		});
		it('should return an instance with mspid', () => {
			const inst = client.getPeer('name', 'mspid');
			inst.type.should.equal('Peer');
			inst.name.should.equal('name');
			inst.mspid.should.equal('mspid');
			inst.something = 'something';
			const inst2 = client.getPeer('name');
	...
	describe('#newOrderer', () => {
		...
		it('should return an instance', () => {
			const inst = client.newOrderer('name');
			inst.type.should.equal('Orderer');
			inst.name.should.equal('name');
		});
		it('should return an instance with mspid', () => {
			const inst = client.newOrderer('name', 'mspid');
			inst.type.should.equal('Orderer');
			inst.name.should.equal('name');
			inst.mspid.should.equal('mspid');
		});
	...
	describe('#getOrderer', () => {
		...
		it('should return an instance', () => {
			const inst = client.getOrderer('name');
			inst.type.should.equal('Orderer');
			inst.name.should.equal('name');
		});
		it('should return an instance with mspid', () => {
			const inst = client.getOrderer('name', 'mspid');
			inst.type.should.equal('Orderer');
			inst.name.should.equal('name');
			inst.mspid.should.equal('mspid');
			inst.something = 'something';
			const inst2 = client.getOrderer('name');
			inst2.something.should.equal('something');
		});
	});
	describe('#newEventer', () => {
