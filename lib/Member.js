...
module.exports = api.Member.extend(/** @lends module:Member.Member.prototype */{
            ...
            if (enrollment) {
                ...
                .then(
                    function(enrollment) {
                        ...
                        self._enrollment.queryStateKey
                            = self._chain.cryptoPrimitives.generateNonce();
                    ...
                    function(data) {
                        ...
                        var ecdsaChainKey
                            = self._chain.cryptoPrimitives.ecdsaPEMToPublicKey(self._enrollment.chainKey);
    ...
    restoreState() {
        ...
        return new Promise(function(resolve, reject) {
            self._keyValStore.getValue(self._keyValStoreName).then(
                function(memberStr) {
                    if (memberStr) {
