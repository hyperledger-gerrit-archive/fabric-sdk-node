...
var Member = class {
	 ...
	 *
	 * @param [{ProposalResponse}] proposalResponses - An array of ProposalResponse objects containing
	...
	sendTransaction(proposalResponses, chaincodeProposal) {
		...
		if(Array.isArray(proposalResponses)) {
			proposalResponse = proposalResponses.pop();
	 ...
	 *		targets : [{Peer}] An array of Endorsing Peer objects as the targets of the request
