...
module.exports.Enrollment = Base.extend(/** @lends module:api.Enrollment.prototype */{
    /**
     * @property {Buffer} private key generated locally by the SDK
     */
    key: null,

    /**
     * @property {string} certificate issued by member services after successful enrollment
     */
    cert: "",

    /**
     * @property {string} what's the best description for this?
     */
    chainKey: ""
});
