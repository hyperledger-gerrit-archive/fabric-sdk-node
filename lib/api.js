...
module.exports.CryptoSuite = class {
	 ...
	 */
	setHashAlgorithm(hashAlgorithm /*string*/ ) {}
	 ...
	 * @param {string} encoding "hex" or other encoding scheme
	 * @returns {Object} an associative array which has the following parameters:
	 *   priv - null, as only the public key is needed for
	 *   encryption pub - RSAKey or ECDSA object of public key
	 */
...
module.exports.MemberServices = class {
	 ...
	 */
	register(req /*RegistrationRequest*/ , registrar /*Member*/ ) {}
	 ...
	 */
	getTCertBatch(req /*GetTCertBatchRequest*/ ) {}
