...
var Chain = class {
	...
	constructor(name) {
		...
		this._tcertBatchSize = global.hfc.config.get('tcert-batch-size',200);
		...
		this._deployWaitTime = global.hfc.config.get('deploy-wait-time',20);
		this._invokeWaitTime = global.hfc.config.get('invoke-wait-time',5);
