...
node ('hyp-x') { // trigger build on x86_64 node
    try {
     ...
     env.NODE_VER = "8.11.3"
     evn.ORG_NAME = "hyperledger/fabric"
     env.PROJECT_DIR = "gopath/src/github.com/hyperledger"
     env.NEXUS_REPO_URL = "nexus3.hyperledger.org:10001"
     env.STABLE_TAG = "1.3.1-stable"
     env.BASE_FOLDER = "$WORKSPACE/gopath/src/github.com/hyperledger"
     ...
     env.GOROOT = "/opt/go/go1.10.4.linux.amd64"
      ...
      stage("Fetch Patchset") { // fetch gerrit refspec on latest commit
          try {
              ...
              sh '''
                 ...
                 git log -2 // Check the latest HEAD
              '''
              }
          }
          catch (err) {
