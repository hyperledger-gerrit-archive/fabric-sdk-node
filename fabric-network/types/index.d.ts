...
export interface Network {
	...
	addBlockListener(listenerName: string, callback: (error: Error, block?: Client.Block) => Promise<void> | void, options?: EventListenerOptions): Promise<BlockEventListener>;
