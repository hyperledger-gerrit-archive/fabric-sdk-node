...
describe('AbstractEventListener', () => {
	...
	describe('#constructor', () => {
		...
		it('should call the checkpointer factory if it is set', () => {
			...
			const listener = new AbstractEventListener(networkStub, 'testlistener', () => {}, {checkpointer: checkpointerFactoryStub});
	...
	describe('#register', () => {
		...
		it('should not call checkpointer._initialize() or checkpointer.load()', () => {
		...
		it('should disconnect and reset the event hub if it emits the wrong type of events', () => {
