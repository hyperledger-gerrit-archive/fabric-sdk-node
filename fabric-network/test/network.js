...
describe('Network', () => {
	...
	describe('#addCommitListener', () => {
		...
		it('should create options if the options param is undefined', () => {
			const listener = network.addCommitListener(listenerName, callback, null, mockEventHub);
			listener.should.to.be.instanceof(TransactionEventListener);
		...
		it('should create an instance of BlockEventListener and add it to the list of listeners', () => {
			const listener = network.addCommitListener(listenerName, callback, {}, mockEventHub);
			listener.should.to.be.instanceof(TransactionEventListener);
			listener.eventHub.should.to.equal(mockEventHub);
			network.listeners.get(listenerName).should.to.equal(listener);
		});
	...
	describe('#addBlockListener', () => {
		...
		it('should create options if the options param is undefined', () => {
			const listener = network.addBlockListener(listenerName, callback);
