 ...
 * network, and enables access to any of the blockchain [Networks]{@link module:fabric-network.Network} (channels) for
 * which that peer is a member. This in turn provides access to Smart [Contracts]{@link module:fabric-network.Contract}
 * (chaincode) running within that blockchain network, and to which
 * [Transactions]{@link module:fabric-network.Transaction} can be
