...
class Gateway {
	 ...
	 * @property {Function} startLstening Returns a Promise that resolves when the handler has started listening for
	 * transaction commit events. Called priot to submission of the transaction to the orderer.
	 * @property {Function} waitForEvents Returns a Promise that resolves (or rejects) when suitable transaction
