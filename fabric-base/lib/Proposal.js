...
const Proposal = class {
	...
	/**
	 * Use this method with a TransactionContext that contains a User that has
	 * a Signing Identity. This method will build and then sign the commit
	 * request.
	 * Do not use this method when signing the proposal outside of this object.
	 * Use the
	 * {@link Proposal#buildUnsignedCommit} to build the bytes of the request
	 * that require a signature. Externally sign those bytes and then set the
	 * signature on this object using {@link Proposal#setCommitSignature} so
	 * this object may then be used for the submission of the commit request
	 * with {@link Proposal#commit}.
	 * 
	 * @param {TransactionContext} txContext - Contains the {@link User} object
	...
	/**
	 * Use this method with a TransactionContext that contains a User that has
	 * a signing identity. This method will be called internally by the
	 * {@link Proposal#buildAndSignCommit} after it builds the submission bytes
	 * based on the current attributes of this proposal's endorsement results.
	 * Do not use this method when signing the proposal outside of this object.
	 * 
	 * @param {TransactionContext} txContext - Contains the {@link User} object
	 * needed to sign this submission.
	 * {@link Proposal#buildUnsignedProposal}.
	 * @param {bytes[]} payload_bytes - The payload in bytes of the commit request 
	 */
