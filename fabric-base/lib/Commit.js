...
class Commit extends Proposal {
	 ...
	 * @property {Endorsement} [endorsement] - Optional. The Endorsement
	 *  that will be committed. This endorsement will override the
	 *  endorsement provided when this instance was created.
	 */
	/**
	...
	build(idContext, request) {
		...
		this._action.payload.setHeader(this._endorsement._proposal.header);
	...
	/**
	 * @typedef {Object} CommitRequest
	 * @property {Orderers[]} [targets] - Optional. The Orderers to send the endorsements.
