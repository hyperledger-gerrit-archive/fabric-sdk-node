...
const CollectionConfig = require('fabric-client/lib/SideDB.js');
...
/**
 * @classdesc
 * The Chaincode class represents a Chaincode definition.
 * <br><br>
...
const Chaincode = class {
	 ...
	 */
	constructor(name = checkParameter('name'), version = checkParameter('version'), client = checkParameter('client')) {
