...
class Orderer extends Remote {
	...
	/**
	 * Connects to an Orderer with the given url and opts.
	...
	sendBroadcast(envelope = checkParameter('envelope'), timeout) {
		...
		return new Promise((resolve, reject) => {
			...
			// if it timeouts now that the send of envelope has completed
			// we will get a REQUEST_TIMEOUT
