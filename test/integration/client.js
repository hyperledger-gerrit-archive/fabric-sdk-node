...
test('\n\n ** createUser happy path - file store **\n\n', function (t) {
	...
	var userOrg = 'org1';
	var dirname = path.join(__dirname, caImport.orgs[userOrg].cryptoFilePath);
	...
	.then((store) => {
		...
		return client.createUser(
			{username: caImport.orgs[userOrg].username,
				...
				cryptoContent: dirname,
				keyStoreOpts: keyStoreOpts,
				privateKeyStore: caImport.orgs[userOrg].privateKeyStore,
				signedCert: caImport.orgs[userOrg].signedCert
			});
	}, (err) => {
