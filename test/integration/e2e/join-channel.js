...
function joinChannel(org, t) {
	...
	return hfc.newDefaultKeyValueStore({
		...
		var keyPath = path.join(__dirname, util.format('../../fixtures/channel/crypto-config0/peerOrganizations/%s.example.com/peers/peer0.%s.example.com/keystore', org, org));
		var keyPEM = Buffer.from(readAllFiles(keyPath)[0]).toString();
		var certPath = path.join(__dirname, util.format('../../fixtures/channel/crypto-config0/peerOrganizations/%s.example.com/peers/peer0.%s.example.com/signcerts', org, org));
