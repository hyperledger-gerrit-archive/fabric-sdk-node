...
test('\n\n***** use the network configuration file  *****\n\n', function(t) {
	...
	.then((nothing) => {
		...
		// This step is to set the signing context for the actions based on of the last
		// network configuration loaded.
		client.setAdminFromConfig();
		t.pass('Successfully loaded the \'admin\' for org1');
		...
		// reset the admin to be a from org2
		client.setAdminFromConfig();
