...
/*
	...
	*/
	const client = await Client.loadFromConfig('test/fixtures/org1.yaml');
...
test('\n\n***** use the connection profile file  *****\n\n', async (t) => {
	...
	//  organization.
	const client_org1 = await Client.loadFromConfig('test/fixtures/network.yaml');
	const client_org2 = await Client.loadFromConfig('test/fixtures/network.yaml');
	...
	await client_org1.loadFromConfig('test/fixtures/org1.yaml');
	await client_org2.loadFromConfig('test/fixtures/org2.yaml');
