...
test('Test chaincode instantiate with event, transaction invocation with chaincode event, and query number of chaincode events', (t) => {
	...
	Client.newDefaultKeyValueStore({
		...
		if(all_good) {
			...
			return channel.sendTransaction({proposalResponses: proposalResponses,	proposal: proposal});
		} else {
		...
		t.pass('Successfully submitted the instantiate transaction to the orderer - will sleep now');
