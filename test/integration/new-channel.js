...
test('\n\n***** SDK Built config update  create flow  *****\n\n', function(t) {
	...
	return Client.newDefaultKeyValueStore({
		...
		client.addMSP( loadMSPConfig('OrdererMSP', '../fixtures/channel/crypto-config0/ordererOrganizations/example.com/orderers/orderer.example.com/'));

		client.addMSP( loadMSPConfig('Org1MSP', '../fixtures/channel/crypto-config0/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/'));

		client.addMSP( loadMSPConfig('Org2MSP', '../fixtures/channel/crypto-config0/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/'));
