...
test('\n\n***** configtxlator flow for create and then update  *****\n\n', function(t) {
	...
	return Client.newDefaultKeyValueStore({
		...
		// we would like to just pass both of the config objects to the superagent directly with the .field()
		// but that does not work, writing to a file so we can use the .attach() which does work
		...
		// call to compute the ConfigUpdate object from the two Config objects
