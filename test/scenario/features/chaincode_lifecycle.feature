...
Feature: Use the v2.0 chaincode lifecycle process
	...
	Scenario: Using the SDK I can run new chaincode
		...
		And I can package node chaincode at version v1 named example_cc as organization org1 located at ../../../../test/fixtures/chaincode/node_cc/example_cc and metadata located at ../../../../test/fixtures/chaincode/metadata
		And I can package java chaincode at version v2 named example_cc as organization org1 located at ../../../../test/fixtures/chaincode/node_cc/example_cc and metadata located at ../../../../test/fixtures/chaincode/metadata
		And I can package golang chaincode at version v3 named example_cc as organization org1 located at github.com/example_cc and metadata located at ../../../../test/fixtures/chaincode/metadata
