...
var FabricCOPClient = require('../../lib/impl/FabricCOPImpl').FabricCOPClient;
...
test('FabricCOPClient: Test constructor', function (t) {
	...
	t.throws(
		...
		'FabricCOPClient: throw error for missing protocol'
	);
	...
	t.throws(
		...
		/Invalid connection options.  Protocol must be set to 'http' or 'https'/,
		'FabricCOPClient: throw error for invalid protocol'
	);
	...
	t.doesNotThrow(
		...
		/Invalid connection options.  Protocol must be set to 'http' or 'https'/,
		'FabricCOPClient: http is a valid protocol'
	);
	...
	t.doesNotThrow(
		...
		/Invalid connection options.  Protocol must be set to 'http' or 'https'/,
		'FabricCOPClient: https is a valid protocol'
	);
	...
	t.throws(
		...
		'FabricCOPClient: throw error for missing hostname'
	);
	...
	t.doesNotThrow(
		...
		'FabricCOPClient: should not throw error if port is not set'
	);
	...
	t.throws(
		...
		/Invalid connection options.  Port must be an integer/,
		'FabricCOPClient: throw error for invalid port'
	);
	...
	t.doesNotThrow(
		...
		/Invalid connection options.  Port must be an integer/,
		'FabricCOPClient: integer is a valid type for port'
	);
