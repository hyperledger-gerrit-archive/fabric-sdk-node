...
test('\n\n ** configuration testing **\n\n', async (t) => {
	...
	'able to instantiate a new instance of "Channel" with the definition in the common connection profile'
	);
	...
	try {
		const client = await Client.loadFromConfig('test/fixtures/network.yaml');
		t.pass('Successfully loaded a common connection profile');
		t.pass('Should be able to try to load an admin from the config');

		await client.loadFromConfig('test/fixtures/org1.yaml');
	...
	const clientp1 = await Client.loadFromConfig('test/fixtures/network.yaml');
	t.pass('Successfully loaded a common connection profile');
	await clientp1.loadFromConfig('test/fixtures/org1.yaml');
	t.pass('Should be able to load an additional config ...this one has the client section');
	...
	const clientp2 = await Client.loadFromConfig('test/fixtures/network.yaml');
	t.pass('Successfully loaded a common connection profile');
	await clientp2.loadFromConfig('test/fixtures/org1.yaml');
	t.pass('Should be able to load an additional config ...this one has the client section');
	...
	const clientp3 = await Client.loadFromConfig('test/fixtures/network.yaml');
	t.pass('Successfully loaded a common connection profile');
	await clientp3.loadFromConfig('test/fixtures/org1.yaml');
	t.pass('Should be able to load an additional config ...this one has the client section');
	...
	const clientp4 = await Client.loadFromConfig('test/fixtures/network.yaml');
	t.pass('Successfully loaded a common connection profile');
...
test('\n\n ** channel testing **\n\n', async (t) => {
	...
	client.setCryptoSuite(suite);
	client.setUserContext(new User('testUser'), true);
	await client.loadFromConfig('test/fixtures/network.yaml');
