...
test('\n\n ** DiscoveryEndorsementHandler - test **\n\n', async (t) => {
	...
	t.deepEquals(map_test_array.a, test_array[0], 'Check that internal method _create_map is working');
	t.deepEquals(map_test_array.b, test_array[1], 'Check that internal method _create_map is working');
	t.deepEquals(map_test_array.c, test_array[2], 'Check that internal method _create_map is working');
