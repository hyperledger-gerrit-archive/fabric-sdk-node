...
test('CryptoSuite_ECDSA_SHA constructor tests', function(t) {
	...
	var cryptoHfc = hfc.newCryptoSuite_ECDSA_SHA();
	t.equal(256, cryptoHfc.getSecurityLevel(),
		'CryptoSuite_ECDSA_SHA constructor tests: crytoHfc default getSecurityLevel() == 256');

	keyPair = cryptoHfc.generateKeyPair();
	t.equal('secp256r1', keyPair.pubKeyObj.curveName,
		'CryptoSuite_ECDSA_SHA constructor tests: cryptoHfc keyPair.pubKeyObj.curveName == secp256r1');
