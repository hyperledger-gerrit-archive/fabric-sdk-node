...
test('\n\n ** test related APIs for create channel **\n\n', function (t) {
	...
	var p1= client.buildChannelConfigUpdate(
		...
		if (err.message.indexOf('Channel config_definition parameter is required') >= 0) {
	...
	var p2= client.buildChannelConfigUpdate({}
		...
		if (err.message.indexOf('he chain update parameter is requried') >= 0) {
			t.pass('Successfully caught he chain update parameter is requried');
		} else {
