...
Use the gulp task `gulp install-and-generate-certs` to perform the above. This is only required to be performed upon initial project clone, and then yearly afterwards.
