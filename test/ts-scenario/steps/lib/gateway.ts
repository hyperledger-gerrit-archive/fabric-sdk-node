 ...
 */
export async function createGateway(ccp: CommonConnectionProfile, tls: boolean, userName: string, orgName: string, gatewayName: string, useDiscovery: boolean, walletType: string): Promise<void> {
 ...
 */
async function identitySetup(wallet: Wallet, ccp: CommonConnectionProfile, orgName: string, userName: string): Promise<void> {
