...
export async function packageContractForOrg(orgName: string, contractName: string, contractType: string, contractVersion: string,  initRequired: boolean, ccp: CommonConnectionProfile): Promise<void> {
...
export async function installPackagedContractForOrg(orgName: string, contractName: string, ccp: CommonConnectionProfile): Promise<void> {
	const contractSaveName: string = `contract-${orgName}-${contractName}`;
...
export async function approveInstalledContractForOrg(orgName: string, contractName: string, channelName: string, ccp: CommonConnectionProfile, policyType: string): Promise<void> {
	const contractSaveName: string = `contract-${orgName}-${contractName}`;
...
export async function queryCommitReadinessAsOrgOnChannel(orgName: string, contractName: string, channelName: string, ccp: CommonConnectionProfile, expectedStatus: any): Promise<void | undefined> {
	const contractSaveName: string = `contract-${orgName}-${contractName}`;
...
export async function retrieveContractPackageAsOrgOnChannel(orgName: string, contractName: string, channelName: string, ccp: CommonConnectionProfile): Promise<Client.GetInstalledChaincodePackageResult | undefined> {
	const contractSaveName: string = `contract-${orgName}-${contractName}`;
...
export async function queryForDefinedContractAsOrgOnChannel(orgName: string, contractName: string, channelName: string, ccp: CommonConnectionProfile, expected: any): Promise<void> {
	const contractSaveName: string = `contract-${orgName}-${contractName}`;
...
export async function performContractCommitWithOrgOnChannel(contractName: string, orgName: string, channelName: string, ccp: CommonConnectionProfile): Promise<void> {
	const contractSaveName: string = `contract-${orgName}-${contractName}`;
...
export async function performContractTransactionForOrg(contract: string, contractFunction: string, contractArgs: any, orgName: string, channelName: string, ccp: CommonConnectionProfile, isSubmit: boolean, expectedResult: any, expectedError: any): Promise<any> {
