...
Feature: Use the channel query methods
	...
	Background:
 	...
 	Scenario: Using a V2 channel object, I can query for chaincode information
		...
		When I perform a queryInstalledChaincodes operation on channel channelopschannelvtwo with Org1 the response matches fields {"installed_chaincodes": [{"label":"fabcar"}]}
