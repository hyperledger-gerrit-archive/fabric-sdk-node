...
Feature: Use the v2.0 chaincode lifecycle process to perform lifecycle operations on all supported smart contract languages
	...
	Scenario: Using the SDK I can run node smart contracts thorough their lifecycle on a two org network
	...
	Scenario: Using the SDK I can run Java smart contracts thorough their lifecycle on a two org network
	...
	Scenario: Using the SDK I can run GoLang smart contracts thorough their lifecycle on a two org network
