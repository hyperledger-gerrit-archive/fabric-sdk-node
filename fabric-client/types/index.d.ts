...
declare class Client extends BaseClient {
  ...
  getTargetOrderer(request_orderer: string | Client.Orderer): Client.Orderer;
  getTargetOrderer(request_orderer: null | undefined, channel_orderers: Client.Orderer[]): Client.Orderer;
  getTargetOrderer(request_orderer: null | undefined, channel_orderers: null | undefined, channel_name: string): Client.Orderer;
...
declare namespace Client {
  ...
  export class Channel {
    ...
    getEndorsementPlan(endorsement_hints?: DiscoveryChaincodeInterest[]): Promise<DiscoveryResultEndorsementPlan>;
    ...
    static sendSignedTransaction(request: SignedCommitProposal, timeout?: number): Promise<BroadcastResponse>;
    static buildEnvelope(clientContext: any, chaincodeProposal: any, endorsements: any, proposalResponse: any, use_admin_signed: boolean): any;
