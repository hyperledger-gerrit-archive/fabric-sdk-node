...
declare abstract class BaseClient {
  ...
  static newCryptoSuite(): Client.ICryptoSuite;
  static newCryptoKeyStore(obj?: { path: string }): Client.ICryptoKeyStore;
  static newDefaultKeyValueStore(obj?: { path: string }): Promise<Client.IKeyValueStore>;
  static normalizeX509(raw: string): string;
  setCryptoSuite(suite: Client.ICryptoSuite): void;
  getCryptoSuite(): Client.ICryptoSuite;
}
...
declare namespace Client {
  ...
  export class Channel {
    ...
    queryBlock(blockNumber: number, target?: Peer | string, useAdmin?: boolean): Promise<any>;
    queryBlockByHash(block: Buffer, target?: Peer | string, useAdmin?: boolean): Promise<any>;
    queryTransaction(txId: string, target?: Peer | string, useAdmin?: boolean): Promise<any>;
    queryBlockByTxID(txId: string, target?: Peer | string, useAdmin?: boolean): Promise<any>;
    queryInstantiatedChaincodes(target: Peer | string, useAdmin?: boolean): Promise<ChaincodeQueryResponse>;
    queryInfo(target?: Peer | string, useAdmin?: boolean): Promise<any>;
    getOrderers(): Orderer[];
    getPeers(): Peer[];
