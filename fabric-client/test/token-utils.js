...
describe('token-utils', () => {
	...
	describe('#buildTokenCommandHeader', () => {
		...
		it('should return a token command header', () => {
			...
			header.encode().should.deep.equal(expectedHeader.encode());

			// verify each field
			// header.channel_id.should.equal(expectedHeader.channel_id);
			// header.creator.should.deep.equal(expectedHeader.creator);
			// header.nonce.should.deep.equal(expectedHeader.nonce);
			// header.nonce.should.deep.equal(expectedHeader.tls_cert_hash);
			// header.should.deep.equal(expectedHeader);
		});
