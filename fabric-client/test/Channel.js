...
describe('Channel', () => {
	...
	describe('#queryChaincodeDefinition', () => {
		...
		beforeEach(() => {
			...
			sinon.stub(peer2, 'sendProposal').resolves(createTransactionResponse(queryResult.toBuffer()));
		...
		it('throws if request object missing targets', () => {
		...
		it('returns valid peer response payloads', async () => {
			const results = await channel.queryChaincodeDefinition(request);
