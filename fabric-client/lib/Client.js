...
var Client = class extends BaseClient {
	 ...
	 * @property {boolean} skipPersistence Whether to skip saving this new user object into persistence. It will be passed to the second param when calling {@link Client#setUserContext}
	 */
