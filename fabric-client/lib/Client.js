...
const Client = class extends BaseClient {
	 ...
	 * @throws {Error} - Will throw an error if generating the new merged object
	 *         fails.
	 */
	 ...
	 * available to be merged into an application's options using the
	 * {@link Client#buildConnectionOptions} or when a channel
