...
const Client = class extends BaseClient {
	...
	async createUser(opts) {
		...
		if (privateKeyPEM) {
			...
			if (opts.skipPersistence && this.getCryptoSuite() == null) {
				// need to create a tmp software cryptoSuite to get the key obj
				const cryptoSuite = sdkUtils.newCryptoSuite({ software: true });
				importedKey = await cryptoSuite.importKey(privateKeyPEM.toString(), { ephemeral: true });
			} else {
