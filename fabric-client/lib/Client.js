...
var Client = class extends BaseClient {
	 ...
	 *                      When user is an object that contains username and optionaly the password and a network
	 *                      configuration has been loaded, the user will be created and set to this client instance
	 *                      based on the current network configuration( ie. the current organization's CA, current
	 *                      persistence stores).
