...
var Client = class extends BaseClient {
	 ...
	 *           to this client's orgainization will be used as defined in the
	 *           network configuration. If 'channels' property is included, the
	 *           target peers willl be based the peers defined in the channels.
