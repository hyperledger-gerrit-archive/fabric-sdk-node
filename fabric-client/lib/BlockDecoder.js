...
last_update
   ...
   * to collect endorsements, getting globally orderer in the context of a channel,
   ...
   * <br><br>
   * Each entry of the "actions" array is a pair of chaincode proposal and proposal
...
signatures -- {array}
  ...
  /**
   * Most of the configuration settings that govern how the fabric should maintain
   * the channel are included in the Blocks of a channel itself. When a block contains
