...
nonce -- {byte[]}
	 ...
	 * main content of a configuration block. Another type of blocks is those
...
values
	 ...
	 * @property {OrganizationConfigGroup} groups.Orderer.groups.&ltorderer_org_name&gt These are the orderer organizatoin names defined on the network
	 * @property {OrganizationConfigGroup} groups.Application.groups.&ltpeer_org_name&gt These are the peer organization names defined on the network
