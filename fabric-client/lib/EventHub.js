 ...
 * has been successfully [endorsed]{@link Channel#sendTransactionProposal}, and
 ...
 * containing the transaction gets added to the ledger/blockchain.
 * <br><br>
 * Fabric committing peers provides an event stream to publish events to registered
 * listeners. As of v1.0, the only events that get published is Block events. A
 ...
 * <li>register a "chaincode event listener" to get call when a specific
...
var EventHub = class {
	 ...
	 * registers at least one event listener, by calling any one of the
	 ...
	 *                             regex string to match more than one events by this
	 *                             chaincode
