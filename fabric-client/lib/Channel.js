...
var Channel = class {
	 ...
	 * defined in this channel that are in the named orgainization.
	 *
	...
	joinChannel(request, timeout) {
		...
		const targets = this._getTargets(request.targets); //no role, will get all peers
...
var ChannelPeer = class {
	 ...
	 * A channel peer object holds channel based referrences:
	...
	/**
	 * Close the assoicated peer service connections.
	 */
	close() {
		this._peer.close();
