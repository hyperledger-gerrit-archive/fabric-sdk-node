 ...
 * and an orderer.
 * <br><br>
 * A client application can use the Channel objects to create new channels with the orderer,
 ...
 * proposal responses. must be initialized after it has been configured with the list of peers
...
var Channel = class {
	 ...
	 * calls this method under the cover to automate the acquisition of the genesis block
	 ...
	 * @returns {Block} The block matching the hash, fully decoded.
	 */
	 ...
	 *                        the query is sent to the first peer that was added to the channel object.
	 * @returns {Block} The block at the blockNumber slot in the ledger.
	 */
	 ...
	 * committed to the channel's ledger, the chaincode is then considered activated
	 * and ready to take requests to process transactions.
	 *
	 ...
	 *				                when not provided the peers added to this channel object will be used.
	 ...
	 * lifecycle in the fabric. The orderer will globally orderer the transactions in the
