...
const Channel = class {
	...
	/*
	 * Internal method to check the incoming request object to be sure all the chaincode settings
	 * are available
	 *
	 ...
	 */
	_verifyChaincodeDefineRequest(request) {
	...
	/**
	 * This method will build and send a "define chaincode for organization"
	 ...
	 */
	async defineChaincodeForOrg(request, timeout) {
		const method = 'defineChaincodeForOrg';
		logger.debug('%s - start', method);

		this._verifyChaincodeDefineRequest(request);
	...
	/**
	 * This method will build and send a "define chaincode for channel"
	 * transaction to the fabric lifecycle system chaincode.
	 * see {@link Chaincode}
	 *
	 * @async
	 ...
	 * @return {Object} Return object will contain the proposalResponses and the proposal
	 */
	async defineChaincode(request, timeout) {
		const method = 'defineChaincode';
		logger.debug('%s - start', method);
