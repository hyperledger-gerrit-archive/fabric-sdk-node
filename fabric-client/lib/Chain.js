...
function buildChannelHeader(type, chain_id, tx_id, epoch, chaincode_id, time_stamp) {
	...
	if(!time_stamp) {
		time_stamp = new _timestampProto.Timestamp();
//		var now = new Date();
//		var seconds = now.getSeconds();
//		time_stamp.setSeconds(seconds); //TODO need a way to get time since 0001.01.01 not 1970.01.01
		logger.debug('buildChannelHeader - set time_stamp to %j',time_stamp);
	}
