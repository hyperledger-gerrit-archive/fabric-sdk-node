...
var Chain = class {
	 ...
	 * Peer must be a peer on this chains peer list.
	 * Default: When not primary peer has not been set the first peer
	 ...
	 * The peer to use for doing queries. When the primary peer
	 * has not been set, the primary peer will be the first peer on
	 * the list.
