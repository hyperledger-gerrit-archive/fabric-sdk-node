...
metadata
   metadata -- [array] #each array item has it's own layout
	 ...
	 * <br>A "Header" will have the following JSON layout.
<br><pre>
   channel_header
      type -- {string}
      version -- {int}
   ...
   signature_header
	 ...
	 * <br>A "Config" will have the following JSON layout.
<br><br><pre>
config
   sequence -- {int}
...
last_update
	...
	*/
	 ...
	 * <br>A "Transaction" will have the following JSON layout.
<br><br><pre>
actions
   ...
   action
	 ...
	 * <br>A "ConfigUpdate" will have the following JSON layout.
<br><br><pre>
   channel_id -- {string}
   ...
   signatures -- [array]
	 ...
	 * <br>A channel level "ConfigGroup" will have the following JSON layout.
<br><br><pre>
      version -- {int}
      mod_policy -- {string}
      groups
	 ...
	 * <br>A organizational "ConfigGroup" will have the following JSON layout.
<br><br><pre>
version -- {int}
mod_policy -- {string}
groups
...
policies
   ...
   Readers
	 ...
	 * <br>A "ImplicitMetaPolicy" will have the following JSON layout.
<br><br><pre>
type -- IMPLICIT_META
policy
   policy
	 ...
	 * <br>A "SignaturePolicy" will have the following JSON layout.
<br><br><pre>
type -- SIGNATURE
policy
   policy
