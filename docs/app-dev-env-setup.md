...
For chaincode development, please visit
[here](http://hyperledger-fabric.readthedocs.io/en/latest/)
and search on `chaincode`

For complete information on starting a [network](http://hyperledger-fabric.readthedocs.io/en/latest/getting_started.html).
...
[this guide](http://hyperledger-fabric.readthedocs.io/en/latest/getting_started.html#crypto-generator)
...
[instructions here](http://hyperledger-fabric.readthedocs.io/en/latest/getting_started.html#configuration-transaction-generator)
...
[instructions here](http://hyperledger-fabric.readthedocs.io/en/latest/getting_started.html#start-the-network-no-tls)
