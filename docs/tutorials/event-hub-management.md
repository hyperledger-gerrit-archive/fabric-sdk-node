This tutorial describes how to define the behaviour of the event hub selection strategy used when event hubs disconnect or new event hubs are required.
